---
title: "Statistical analysis for \"Investigation of Structural Alterations in Inherited
  Retinal Diseases: A Quantitative SD-OCT-Analysis of Retinal Layer Thicknesses in Light
  of Underlying Genetic Mutations\""
...
```{r match_rp, cache=TRUE, fig.asp=20.5/16, fig.cap="**Mean difference in thickness between RP and controls by layer and segment.** Significant differences are denoted with a star (*)."}
datl <- dat %>%
...
```{r match_crd, cache=TRUE, fig.asp=20.5/16, fig.cap="**Mean difference in thickness between CRD and controls by layer and segment.** Significant differences are denoted with a star (*)."}
matched_crd <- dat %>%
...
```{r match_stgd, cache=TRUE, fig.asp=20.5/16, fig.cap="**Mean difference in thickness between STGD and controls by layer and segment.** Significant differences are denoted with a star (*)."}
matched_stgd <- dat %>%
